...
export const HeroBanner = ({ heroBanner }) => {
  ...
  return (
    <section className='flex flex-row relative h-full bg-gray-900 text-white overflow-hidden border border-red-500'>
      <div className="relative size-96 w-3xl rounded-2xl  m-4 height-full  flex items-center justify-center text-white overflow-hidden border border-blue-500 transform hover:scale-102">
      ...
      <div className="absolute inset-0 z-20 flex items-center justify-center">
        <h2 className='bg-red-900'>Hello</h2>
      </div>
      
      <div className="absolute bg-black/70 inset-0 z-10 -mt-20 flex flex-col items-center justify-center px-6 text-center">
        <motion.div 
      ...
      <div className="relative m-4 border border-green-500">
        <div className="relative size-96 w-2xs rounded-2xl m-4 h-32  flex items-center justify-center text-white overflow-hidden borde r border-blue-500">
      ...
      <div className="relative w-md m-4 height-full border border-white">
        <div className="relative size-44 w-sm m-4 height-full  flex items-center justify-center text-white overflow-hidden border border-blue-500">
      ...
      {loaded && instanceRef.current && (
        ...
        <div className="flex items-center space-x-4 m-2">
          <span className="text-white">Trending News</span>
          <hr className="flex-grow border border-white" />
        </div>
{/* ------------------------------------------------------------------------------------------------ */}
      <div className="relative w-sm m-4 h-40 border border-white">
        <div className="flex flex-row w-xm rounded-xl m-4 h-20 border border-blue-500">
          <div className="relative w-28 rounded-xl m-2 h-16 border border-blue-500">
          </div>
          <div className="relative w-56 m-2 h-16 border border-blue-500">
          </div>
        </div>
...
export const LatestNews = ({ latestNewsTitle, latestNewsArticles }) => {
  ...
  return (
    <motion.section
      ...
      className="py-5 px-6 max-w-7xl mx-auto border border-green-500"
    >
...
export const FeaturedArticles = ({ featuredArticlesTitle, featuredArticles }) => {
  ...
  return (
    <motion.section
      ...
      viewport={{ once: true }}
      transition={{ duration: 0.6 }}
      className="py-2 px-6 bg-gray-50 border border-yellow-500"
    >
